                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <input type="number" id="bookId" name="bookId" class="form-control col" required value="${book.bookId}"/>
                            </div>

                            <div class="row mb-3">
                                <label for="bookName" class="form-label col-3 col-form-label">제목</label>
                                <input type="text" id="bookName" name="bookName" class="form-control col" required value="${book.bookName}"/>
                            </div>

                            <div class="row mb-3">
                                <label for="publisher" class="form-label col-3 col-form-label">출판</label>
                                <input type="text" id="publisher" name="publisher" class="form-control col" required value="${book.publisher}"/>
                            </div>

                            <div class="row mb-3">
                                <label for="price" class="form-label col-3 col-form-label">가격</label>
                                <input type="number" id="price" name="price" class="form-control col" required value="${book.price}"/>
                            </div>
